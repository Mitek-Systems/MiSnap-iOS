...
Please refer to [DocumentsViewModel.swift](../../../Examples/Apps/MiSnapSampleApp/MiSnapSampleApp/Features/Documents/DocumentsViewModel.swift) in `MiSnapSampleApp` as a working customization example.
