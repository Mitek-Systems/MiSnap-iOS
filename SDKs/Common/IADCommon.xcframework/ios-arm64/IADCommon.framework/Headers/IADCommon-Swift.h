...
#ifndef IADCOMMON_SWIFT_H
#define IADCOMMON_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IADCommon",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
SWIFT_CLASS("_TtC9IADCommon21IADCallReceiverHelper") SWIFT_DEPRECATED_MSG("Use Face/Doc IADController.createIADBundle(...) instead")
