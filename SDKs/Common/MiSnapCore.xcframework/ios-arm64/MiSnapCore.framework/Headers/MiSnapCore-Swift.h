...
typedef SWIFT_ENUM(NSInteger, MiSnapUxpEvent, open) {
  ...
  MiSnapUxpEventInvalidDateVerbose = 40,
  MiSnapUxpEventPaceSupportVerbose = 41,
  MiSnapUxpEventCaSupportVerbose = 42,
  MiSnapUxpEventAaSupportVerbose = 43,
  MiSnapUxpEventAccessMechanismVerbose = 44,
  MiSnapUxpEventDiscardVerbose = 45,
  MiSnapUxpEventCancelVerbose = 46,
  MiSnapUxpEventCancel = 47,
  MiSnapUxpEventInstruction = 48,
  MiSnapUxpEventHelp = 49,
  MiSnapUxpEventTimeout = 50,
  MiSnapUxpEventReview = 51,
  MiSnapUxpEventMeasuredConfidence = 52,
  MiSnapUxpEventMeasuredCornerPoints = 53,
  MiSnapUxpEventMeasuredMicrConfidence = 54,
  MiSnapUxpEventMeasuredContrast = 55,
  MiSnapUxpEventMeasuredBackground = 56,
  MiSnapUxpEventMeasuredAngle = 57,
  MiSnapUxpEventMeasuredRotationAngle = 58,
  MiSnapUxpEventMeasuredSharpness = 59,
  MiSnapUxpEventMeasuredBrightness = 60,
  MiSnapUxpEventMeasuredGlare = 61,
  MiSnapUxpEventMeasuredWidth = 62,
  MiSnapUxpEventMeasuredAutoTime = 63,
  MiSnapUxpEventMeasuredManualTime = 64,
  MiSnapUxpEventMeasuredFailover = 65,
  MiSnapUxpEventTorchOn = 66,
  MiSnapUxpEventTorchOff = 67,
  MiSnapUxpEventStartAuto = 68,
  MiSnapUxpEventStartManual = 69,
  MiSnapUxpEventOrientationLandscape = 70,
  MiSnapUxpEventOrientationPortrait = 71,
};
