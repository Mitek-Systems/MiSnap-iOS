...
#ifndef MISNAPMIBIDATA_SWIFT_H
#define MISNAPMIBIDATA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MiSnapMibiData",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// MIBI
SWIFT_CLASS("_TtC14MiSnapMibiData10MiSnapMibi")
...
- (NSString * _Nullable)addTo:(UIImage * _Nullable)image compression:(float)compression SWIFT_WARN_UNUSED_RESULT;
...
/// Session info
SWIFT_CLASS("_TtC14MiSnapMibiData21MiSnapMibiSessionInfo")
...
SWIFT_CLASS("_TtC14MiSnapMibiData28MiSnapMibiBarcodeSessionInfo")
...
/// Device info
SWIFT_CLASS("_TtC14MiSnapMibiData20MiSnapMibiDeviceInfo")
...
SWIFT_CLASS("_TtC14MiSnapMibiData29MiSnapMibiDocumentSessionInfo")
...
/// Face session info
SWIFT_CLASS("_TtC14MiSnapMibiData25MiSnapMibiFaceSessionInfo")
...
/// NFC session info
SWIFT_CLASS("_TtC14MiSnapMibiData24MiSnapMibiNFCSessionInfo")
...
/// Voice session info
SWIFT_CLASS("_TtC14MiSnapMibiData26MiSnapMibiVoiceSessionInfo")
...
SWIFT_CLASS("_TtC14MiSnapMibiData21MiSnapUxpEventManager")
