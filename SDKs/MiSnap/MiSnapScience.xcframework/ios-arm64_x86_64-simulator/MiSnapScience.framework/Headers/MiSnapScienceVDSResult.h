...
#import <MiSnapScience/MiSnapScienceVDSHeader.h>

NS_ASSUME_NONNULL_BEGIN
/**
 Visible Digital Seal (VDS) Result
 */
@interface MiSnapScienceVDSResult : NSObject
/**
...
/**
 Header
 */
@property (nonatomic, readonly) MiSnapScienceVDSHeader * _Nonnull header;
/**
