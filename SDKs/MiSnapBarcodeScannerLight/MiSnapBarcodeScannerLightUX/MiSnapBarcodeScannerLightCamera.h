//
//  MiSnapBarcodeScannerLightCamera.h
...
@protocol MiSnapBarcodeScannerLightCameraDelegate <NSObject>
...
/*!
 ...
 @abstract
 Called whenever a MiSnapBarcodeScannerLightCamera instance outputs a new video frame.
...
/*! @abstract This method is called after configuration of the MiSnapBarcodeScannerLightCamera
 
 @discussion
 MiSnapBarcodeScannerLightCamera configuration must be done before final UX configuration to allow a smooth
...
/*!
 @class MiSnapBarcodeScannerLightCamera
 @abstract
 MiSnapBarcodeScannerLightCamera is a class that defines an interface for a camera that implements an AVCaptureSession.
 
 @discussion
 MiSnapBarcodeScannerLightCamera is an interface for creating and managing an instance of a camera abstration.
 
 Delegates of a MiSnapBarcodeScannerLightCamera instance that imlement the MiSnapBarcodeScannerLightCameraDelegate protocol will receive the defined callbacks.
 ...
 */
@interface MiSnapBarcodeScannerLightCamera : UIView

/*! @abstract The delegate that implements the MiSnapBarcodeScannerLightCameraDelegate and that will receive the
 required protocol methods from MiSnapBarcodeScannerLightCamera
 */
@property (nonatomic) id <MiSnapBarcodeScannerLightCameraDelegate> _Nullable delegate;
...
/*!
 @abstract Creates an instance of MiSnapBarcodeScannerLightCameraDelegate
 @param sessionPreset the AVCaptureSessionPreset to use
 @param frame the frame for the MiSnapBarcodeScannerLightCamera view
 @return an instance of MiSnapBarcodeScannerLightCamera that is initialized and ready to start
 */
...
/*!
 @abstract Start the camera to begin callbacks from the MiSnapBarcodeScannerLightCameraDelegate
 */
- (void)start;

/*!
 @abstract Stop the camera and callbacks from the MiSnapBarcodeScannerLightCameraDelegate. The camera can
