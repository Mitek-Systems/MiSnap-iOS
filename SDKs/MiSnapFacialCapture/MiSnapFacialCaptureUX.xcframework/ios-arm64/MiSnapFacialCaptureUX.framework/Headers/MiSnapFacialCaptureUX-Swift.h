...
/// Called when a camera received a sample buffer with full capture context for AI based RTS processing
/// note:
/// Only exposed due to public status of parent’s function. Do not call it.
- (void)didReceiveSampleBuffer:(CMSampleBufferRef _Nullable)sampleBuffer fromOutput:(AVCaptureOutput * _Nullable)output connection:(AVCaptureConnection * _Nullable)connection;
