...
#define UXP_IDENTITY_FRONT_FAILURE              @"EIF"
#define UXP_IDENTITY_BACK_FAILURE               @"EIB"
#define UXP_PASSPORT_FAILURE                    @"EP"
#define UXP_MRZ_FAILURE                         @"EM"
#define UXP_CLASSIFICATION_IN_PROGRESS          @"CP"
...
/*!
 @class MiSnapUxpEventManager
 @abstract
 MiSnapUxpEventManager is a class that defines methods to manage UXP Events during a capture session.
